...
export const ConfirmationModal = ({ deletingDoc, setDeletingDoc, handleDelete }) => {
            ...
            <div className="modal">
                <div className="modal-box">
                    ...
                    <div className="modal-action">
                        <label className="btn btn-error" onClick={() => { handleDelete(deletingDoc._id, deletingDoc) }}>Ok!</label>
